...
INSERT INTO `app_tbl` VALUES (24,'APP-2026-01','Annual Procurement Plan for Fiscal Year 2026',81,NULL,NULL,NULL,NULL,NULL,NULL,15,'2026-06-04 17:21:36','Done','2026-06-04 18:08:34',33232.00,0),(26,'APP-2026-01','Annual Procurement Plan for Fiscal Year 2026',5,NULL,NULL,NULL,NULL,NULL,NULL,1,'2026-06-07 22:08:17','Done','2026-06-07 22:09:04',740000.00,1);
...
INSERT INTO `iar_items_specs_tbl` VALUES (1,1,82,'A4 Size, 70/80gsm'),(2,2,83,'Long/Legal Size, 70/80gsm'),(3,4,85,'Advanced Engineering, Computer Science, or Medical Science reference volumes'),(4,5,86,'High-back, adjustable 3D armrests, lumbar support, and nylon base'),(5,6,84,'Infinity Plan optics, 40X–1000X magnification, LED illumination');
...
INSERT INTO `iar_items_tbl` VALUES (1,1,73,NULL,'Bond Paper','Ream',110),(2,1,74,NULL,'Bond Paper','Ream',5),(3,2,76,NULL,'Hardcover International Reference Textbook','Copy',1),(4,2,77,NULL,'Academic E-Journal','Subscription',1),(5,2,78,NULL,'Ergonomic Mesh Office Chair','Piece',1),(6,3,75,NULL,'Trinocular Compound Microscope','Unit',1);
...
INSERT INTO `iar_tbl` VALUES (1,11,NULL,'ITRAC IT Innovation Inc.','14367','14367 / 2026-06-11','College of Education and Sciences',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Complete',5,'2026-06-09 02:58:24'),(2,11,NULL,'ITRAC IT Innovation Inc.','14367','14367 / 2026-06-11','College of Education and Sciences',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Complete',5,'2026-06-09 02:58:24'),(3,11,NULL,'ITRAC IT Innovation Inc.','14367','14367 / 2026-06-11','College of Education and Sciences',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Complete',5,'2026-06-09 02:58:24');
...
INSERT INTO `messages` VALUES (2,81,5,'Pre','2026-05-27 05:45:49','2026-05-27 05:45:34','2026-05-27 05:45:49'),(3,81,5,'pre','2026-05-27 05:46:07','2026-05-27 05:46:05','2026-05-27 05:46:07'),(4,81,5,'pre','2026-05-27 05:46:07','2026-05-27 05:46:06','2026-05-27 05:46:07'),(5,81,5,'pre','2026-05-27 05:46:07','2026-05-27 05:46:06','2026-05-27 05:46:07'),(6,81,5,'asdads','2026-05-27 06:10:23','2026-05-27 06:10:19','2026-05-27 06:10:23'),(7,5,81,'sadasd','2026-05-27 06:10:31','2026-05-27 06:10:29','2026-05-27 06:10:31'),(8,5,2,'Pre','2026-06-04 18:14:50','2026-06-01 21:49:36','2026-06-04 18:14:50'),(9,5,2,'Paki-validate na ng questionnaire namin.','2026-06-04 18:14:50','2026-06-01 21:49:48','2026-06-04 18:14:50');
...
CREATE TABLE `mr_tbl` (
  ...
  `mr_qr_code` varchar(50) NOT NULL,
  `po_item_id_fk` bigint unsigned NOT NULL,
  `owner_id_fk` bigint unsigned DEFAULT NULL,
  `location` varchar(255) DEFAULT NULL,
  `item_image` varchar(255) DEFAULT NULL,
  `status` enum('Pending Assignment','Assigned') DEFAULT 'Pending Assignment',
  `date_received` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`mr_id`),
  UNIQUE KEY `mr_qr_code` (`mr_qr_code`),
  KEY `fk_mr_po_item` (`po_item_id_fk`),
  KEY `fk_mr_owner` (`owner_id_fk`),
  CONSTRAINT `fk_mr_owner` FOREIGN KEY (`owner_id_fk`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `po_items_specs_tbl` VALUES (82,73,'A4 Size, 70/80gsm'),(83,74,'Long/Legal Size, 70/80gsm'),(84,75,'Infinity Plan optics, 40X–1000X magnification, LED illumination'),(85,77,'Advanced Engineering, Computer Science, or Medical Science reference volumes'),(86,78,'High-back, adjustable 3D armrests, lumbar support, and nylon base'),(87,79,'3,800 lumens brightness, 12,000 hours lamp life in Eco Mode, HDMI/USB/VGA connectivity, built-in wireless/moderator capability');
...
INSERT INTO `po_items_tbl` VALUES (73,11,NULL,NULL,'Ream','Bond Paper',110,242.00,NULL,26620.00,'Supply and Materials'),(74,11,NULL,NULL,'Ream','Bond Paper',5,245.00,NULL,1225.00,'Supply and Materials'),(75,11,NULL,NULL,'Unit','Trinocular Compound Microscope',1,57000.00,NULL,57000.00,'Equipment'),(76,11,NULL,NULL,'Copy','Hardcover International Reference Textbook',1,8500.00,NULL,8500.00,'Semi-Expendable'),(77,11,NULL,NULL,'Subscription','Academic E-Journal',1,125000.00,NULL,125000.00,'Semi-Expendable'),(78,11,NULL,NULL,'Piece','Ergonomic Mesh Office Chair',1,6850.00,NULL,6850.00,'Semi-Expendable'),(79,11,NULL,NULL,'Unit','Epson EB-X51 XGA 3LCD Projector',1,28945.00,NULL,28945.00,'Not Delivered');
...
INSERT INTO `po_tbl` VALUES (11,23,'PO_Innovation','ITRAC IT Innovation Inc.','14367','2026-06-11','Barangay Katuparan, Taguig City','09999999999','000-111-222-333','Competitive Bidding','444-555-666-777','TUP Taguig','30 Days Calendar','2026-06-10','Leisure Fund',NULL,NULL,NULL,NULL,NULL,NULL,254140.00,NULL,NULL,NULL,NULL,NULL,NULL,78,'PO-202601001-001','2026-06-09 02:01:21','Done',5);
...
INSERT INTO `pr_tbl` VALUES (23,26,'UITC Room',1,'76123','2026-06-08','Innovation',74,NULL,5,'Dean - College of Education and Sciences',74,'PR-202601-001','Exported','2026-06-07 23:36:11','2026-06-08 07:36:11',227762.00,78);
...
INSERT INTO `ris_items_specs_tbl` VALUES (1,1,82,'A4 Size, 70/80gsm'),(2,2,83,'Long/Legal Size, 70/80gsm'),(3,4,85,'Advanced Engineering, Computer Science, or Medical Science reference volumes'),(4,5,86,'High-back, adjustable 3D armrests, lumbar support, and nylon base');
...
INSERT INTO `ris_items_tbl` VALUES (1,1,73,NULL,'Ream','Bond Paper',110,'Yes',110,NULL),(2,1,74,NULL,'Ream','Bond Paper',5,'Yes',5,NULL),(3,2,76,NULL,'Copy','Hardcover International Reference Textbook',1,'Yes',1,NULL),(4,3,77,NULL,'Subscription','Academic E-Journal',1,'Yes',1,NULL),(5,4,78,NULL,'Piece','Ergonomic Mesh Office Chair',1,'Yes',1,NULL);
...
INSERT INTO `ris_tbl` VALUES (1,11,NULL,NULL,'CES',NULL,NULL,'Innovation',5,NULL,NULL,5,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,'2026-06-09 02:58:24'),(2,11,NULL,NULL,'Property and Supply',NULL,NULL,'Innovation',5,NULL,NULL,5,NULL,NULL,5,NULL,NULL,5,NULL,NULL,'2026-06-09 02:58:24'),(3,11,NULL,NULL,'Procurement',NULL,NULL,'Innovation',78,NULL,NULL,5,NULL,NULL,5,NULL,NULL,78,NULL,NULL,'2026-06-09 02:58:24'),(4,11,NULL,NULL,'Property and Supply',NULL,NULL,'Innovation',79,NULL,NULL,5,NULL,NULL,5,NULL,NULL,79,NULL,NULL,'2026-06-09 02:58:24');
...
INSERT INTO `rsmi_items_specs_tbl` VALUES (1,1,82,'A4 Size, 70/80gsm'),(2,2,83,'Long/Legal Size, 70/80gsm');
...
INSERT INTO `rsmi_items_tbl` VALUES (1,1,NULL,NULL,NULL,'Bond Paper','Ream',110,242.00,26620.00,NULL,NULL,NULL,NULL,NULL),(2,1,NULL,NULL,NULL,'Bond Paper','Ream',5,245.00,1225.00,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `rsmi_tbl` VALUES (1,11,NULL,'14367',NULL,NULL,5,NULL,NULL,NULL,27845.00,'2026-06-09 02:58:24');
...
INSERT INTO `sessions` VALUES ('08MOKGwTEdKJ8C5LrxOs9y2jAEUTm5UCNXGWRb2J',5,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0','',1780982147),('FDqNqE0YATYiygXWt99x9cAlmxJMOtQcCWShv3S3',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36 Edg/149.0.0.0','',1780981703);
...
INSERT INTO `task_items_tbl` VALUES (33,34,38),(34,34,39),(35,34,40),(36,34,41),(37,34,42);
...
INSERT INTO `tasks_tbl` VALUES (34,5,74,NULL,'2026-06-08 06:10:17',23,'Purchase Request',0,'Exported',1);
...
INSERT INTO `user_departments_tbl` VALUES (2,74,1,NULL),(6,78,16,11),(7,19,14,NULL),(13,79,15,NULL),(14,2,15,NULL),(15,59,2,NULL),(20,81,16,NULL),(21,22,5,22),(22,5,15,10),(23,5,1,1);
...
-- Dump completed on 2026-06-10 21:38:13
