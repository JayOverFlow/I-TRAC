...
INSERT INTO `sessions` VALUES ('NbhaKsBA1ZOIJwJGLdeUkScfnwaQeAxb16bg8qD7',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0','',1769154330);
...
CREATE TABLE `users` (
  ...
  `user_middlename` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `user_fullname` varchar(100) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (concat(_utf8mb4'user_firstname',_utf8mb4' ',_utf8mb4'user_middlename',_utf8mb4' ',_utf8mb4'user_lastname',_utf8mb4' ',_utf8mb4'user_suffix',_utf8mb4' ')) VIRTUAL,
  `user_type` enum('Faculty','Staff') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_tupid` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
-- Dump completed on 2026-01-23 17:44:54
