...
CREATE TABLE `app_items_tbl` (
  ...
  `app_items_is_assigned` tinyint NOT NULL DEFAULT '0',
...
INSERT INTO `app_items_tbl` VALUES (1,1,'Class Laboratory Table and Chairs','BASD',NULL,'Small Value Procurement','No','LCRB','2026-01-01 00:00:00','2026-06-01','Fund 05',250000,NULL,NULL,NULL,0),(2,1,'Laptop','BASD','(Goods)','Competitive Bidding',NULL,'LCRB','2026-01-01 00:00:00','2026-07-10','Fund 05',60000,NULL,NULL,NULL,1),(3,1,'Ink for EPSON Printer L3210 / L 3150 (All Black) c/0 Supplies','BASD','20(Goods)',NULL,'No',NULL,'2026-01-01 00:00:00','2026-06-01','Fund 05',NULL,NULL,'c/o Supply Office',NULL,0);
...
INSERT INTO `sessions` VALUES ('hItM7Ip4mmm5PFeLVj02u589NY0uBkEDChgqcJuA',5,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0','',1775485615);
...
INSERT INTO `tasks_tbl` VALUES (1,2,5,'Eme emeng description','2026-04-05 14:08:33',NULL,'emeng task type',0,'Pending');
...
INSERT INTO `user_departments_tbl` VALUES (1,5,1);
...
-- Dump completed on 2026-04-06 22:30:11
