...
INSERT INTO `sessions` VALUES ('FMPTjyAic25PGGsWJeR5QtWWpcCdTQeIvzvluRfq',77,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36','',1777647455),('QdYlWrn8suZaSxOO1OaUJMzhZOggs96Ocgvp1Hp7',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36','',1777646068);
...
INSERT INTO `user_roles_tbl` VALUES (1,2,1),(4,59,5),(6,77,6);
...
CREATE TABLE `users` (
  ...
  `user_contactno` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_profile_photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
-- Dump completed on 2026-05-01 22:58:49
