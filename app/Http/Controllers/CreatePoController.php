    ...
    private function validatePo(Request $request, string $intent): \Illuminate\Validation\Validator
    {
        if ($intent === 'Done') {
            $rules = [
                ...
                'po_tin'              => 'required|string|min:5|max:60',
            ...
            $rules = [
                ...
                'po_tin'              => 'nullable|string|min:5|max:60',
                ...
                'po_tuptin'           => 'nullable|string|min:5|max:60',
        ...
        $messages = [
            ...
            'po_tin.min'                   => 'TIN must be at least 5 characters.',
            'po_tin.max'                   => 'TIN must not exceed 60 characters.',
            ...
            'po_tuptin.min'                => 'TUP-Taguig TIN must be at least 5 characters.',
            'po_tuptin.max'                => 'TUP-Taguig TIN must not exceed 60 characters.',
            ...
            'items.*.stock.required'       => 'Stock No. is required.',
