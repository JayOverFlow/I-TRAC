document.addEventListener('DOMContentLoaded', function () {
    ...
    if (formValidation) {
        ...
        function validateStepOne() {
            ...
            const tuptID = document.querySelector('#tupt-id');
            ...
            const stepOneValidation = {
                ...
                tuptID: {
                    ...
                    messages: {
                        ...
                        pattern: 'TUPT ID must be exactly 6 digits.'
                    }
                }
            };
        ...
        function validateStepTwo() {
            ...
            const userType = document.querySelector('input[name="flexRadioDefault"]:checked');
        ...
        // TUPT ID: integers only, max 6 digits
        const tuptID = document.querySelector('#tupt-id');
        if (tuptID) {
            tuptID.addEventListener('input', function (e) {
