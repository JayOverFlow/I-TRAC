document.addEventListener('DOMContentLoaded', function () {
    ...
    if (formValidation) {
        ...
        // Auto-capitalize TUPT-ID upon typing and restrict to 20 characters
        const tupIdField = document.querySelector('#tup-id');
        if (tupIdField) {
            tupIdField.addEventListener('input', e => e.target.value = e.target.value.toUpperCase().slice(0, 20));
        }
