                        ...
                        <form class="needs-validation" onsubmit="return false" novalidate>
                            ...
                            <div id="validationStep-one" class="content" role="tabpanel">
                                ...
                                <div class="mt-4 text-center">
                                    <p class="black-text">Already have an account? <a href="{{ route('login') }}"
                                            class="red-text">Login.</a></p>
                                </div>
                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="mt-4">
                                                    <input class="form-check-input" type="radio" name="user_type"
                                                        id="user-type-faculty" value="Faculty">
                                                    <label class="form-check-label me-4" for="user-type-faculty">
                                                        Faculty
                                                    </label>

                                                    <input class="form-check-input" type="radio" name="user_type"
                                                        id="user-type-staff" value="Staff">
                                                    ...
                                                    @foreach ($groupedDepartments as $group)
                                                        @if($group['parent'])
                                                            <optgroup label="{{ $group['label'] }}">
                                                                ...
                                                                --}}
                                                                <option value="{{ $group['parent']->dep_id }}">
                                                                    {{ $group['parent']->dep_name }}</option>
                                                                @foreach ($group['children'] as $childDept)
                                                                    <option value="{{ $childDept->dep_id }}">
                                                                        {{ $childDept->dep_name }}</option>
                                                                @endforeach
                                                            </optgroup>
                                                        @endif
                                                    @endforeach
                            ...
                            <div id="validationStep-three" class="content" role="tabpanel">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div>
                                            <h6 class="mb-0">
                                                Password
                                                <button type="button"
                                                    class="btn btn-link p-0 text-decoration-none ms-2 bg-transparent border-0"
                                                    id="toggle-password-review">
                                ...
                                <div class="button-action mt-5 d-flex justify-content-center">
                                    <button class="btn btn-red btn-back me-3">Back</button>
                                    <button class="btn btn-red btn-nxt" id="step3-next-btn" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalCenter">Next</button>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="text-center">
                                            <p class="mb-0 black-text">Didn't receive the code? <a
                                                    href="javascript:void(0);" class="red-text" id="resend-code-btn"
                                                    disabled>Resend</a> <span id="resend-timer"
