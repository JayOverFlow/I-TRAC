    ...
    <div class="card-body d-flex justify-content-between align-items-center flex">
        ...
        <div class="d-flex flex-column">
            ...
            <div class="d-flex align-items-center mt-1">
                <img src="{{ asset('img/user-profile.jpeg') }}" class="avatar-img rounded-circle border border-2 border-white">
                <img src="{{ asset('img/user-profile.jpeg') }}" class="avatar-img rounded-circle border border-2 border-white ms-n2">
                <div class="avatar-add rounded-circle border bg-white d-flex align-items-center justify-content-center ms-n2" style="width: 35px; height: 35px; color: #ccc;">
                    <span>+</span>
                </div>
            </div>
        </div>
    ...
    <div class="card-body card-pad">
        <div class="container pe-0 ps-0">
            ...
            <div class="row">
                ...
                <h6 class="fw-bold">#67 Sen. Gil J. Puyat Ave., Makati City</h6>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="ps-1 pe-1">
                                <div class="article-cell-wrapper">
                                    <div class="input-group ">
                                        <input type="text" class="form-control border-end-0 fw-bold " value="Nintendo Switch">
                                            <span class="input-group-text bg-white border-start-0 add-description-btn">
                                                <img src="{{ asset('img/add-description-btn.png') }}" alt="Add" style="width: 14px; height: 14px;">
                                            </span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="ps-1 pe-1">
                                <div class="btn-group choose-btn" role="group">
                                    <button id="btndefault" type="button" class="dropdown-toggle d-flex align-items-center justify-content-between w-100 h-100" data-bs-toggle="dropdown" data-bs-boundary="window" aria-expanded="false">
                                    Type
                                    <img src="{{ asset('img/dropdown-btn.png') }}" alt=""  class="dropdown-btn">
                                    </buton>

                                    <div class="dropdown-menu" aria-labelledby="btndefault">
                                        <a href="javascript:void(0);" class="dropdown-item"><i class="flaticon-home-fill-1 mr-1"></i>Consumable</a>
                                        <a href="javascript:void(0);" class="dropdown-item"><i class="flaticon-gear-fill mr-1"></i>Equipments</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
