...
<div class="tab-pane fade" id="animated-underline-annual-procurement-plan" role="tabpanel" {{-- Chnange annual-procurement-plan to purchase-request --}}
    aria-labelledby="animated-underline-annual-procurement-plan-tab"> {{-- Change annual-procurement-plan to purchase-request --}}
