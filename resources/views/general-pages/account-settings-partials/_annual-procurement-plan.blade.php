            ...
            initComplete: function() {
                $('.custom-buttons').html(`
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-white d-flex align-items-center px-4 py-2 border border-secondary shadow-sm" style="border-radius: 8px;" onclick="window.location='{{ route('show.import.app') }}'" disabled>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="me-2">
