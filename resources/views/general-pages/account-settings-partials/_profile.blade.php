    ...
    <div class="profile-container" id="profile-section">
        ...
        <div class="profile-sidebar">
            ...
            <div class="profile-avatar-wrapper">
                <div class="avatar-image-container" style="position: relative; display: block; width: 150px; height: 150px; margin: 0 auto;">
                    <img 
                    ...
                    <button class="btn btn-avatar-overlay shadow-none" id="btn-avatar-overlay" type="button" title="Change Photo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download">
                ...
                <div class="info-column">
                    ...
                    <div id="password-static-section" class="info-item">
                        ...
                        <button class="btn btn-change-password shadow-none" id="change-password-btn" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3 mr-2"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                            Change Password
                        </button>
                    </div>
                    ...
                    <div id="password-edit-section" style="display: none;">
                        ...
                        <div class="info-item password-edit-item">
                            ...
                            <div class="password-field">
                                <input type="password" id="input-current-password" name="current_password" class="form-control password-edit-input" placeholder="••••••••••••••••" autocomplete="current-password">
                        ...
                        <div class="info-item password-edit-item">
                            ...
                            <div class="password-field">
                                <input type="password" id="input-new-password" name="new_password" class="form-control password-edit-input" placeholder="••••••••••••••••" autocomplete="new-password">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye-off password-toggle-icon"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                            </div>
                        </div>
                        ...
                        <div class="info-item password-edit-item password-edit-item-last">
                            ...
                            <div class="password-field">
                                <input type="password" id="input-confirm-password" name="confirm_password" class="form-control password-edit-input" placeholder="••••••••••••••••" autocomplete="new-password">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye-off password-toggle-icon"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                            </div>
                        </div>
