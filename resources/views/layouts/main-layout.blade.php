...
<head>
    ...
    {{-- <link href="../layouts/horizontal-light-menu/css/light/loader.css" rel="stylesheet" type="text/css" /> <!-- DONE -->
    <script src="../layouts/horizontal-light-menu/loader.js"></script> <!-- DONE --> --}}

    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    {{-- <link href="../src/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" /> <!-- DONE -->
    <link href="../layouts/horizontal-light-menu/css/light/plugins.css" rel="stylesheet" type="text/css" /> <!-- DONE --> --}}
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- Vite for GLOBAL MANDATORY css and js-->
    @vite(['resources/css/app.css', 'resources/js/app.js'])

    <!-- Vite for SPECIFIC css and js-->
    @vite(['resources/css/main-layout/main-layout.css', 'resources/js/main-layout/main-layout.js'])
   
    <!-- Apply custom.css file to customize the style -->
    {{-- <link href="css/light/custom.css" rel="stylesheet" type="text/css"> --}}
        ...
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="{{ asset('img/logo2.svg') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="navbar-item flex-row ms-md-auto ms-0 action-area">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset('img/1x1/us.svg') }}" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('img/1x1/us.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('img/1x1/tr.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Turkish</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('img/1x1/br.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Portuguese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('img/1x1/in.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Hindi</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('img/1x1/de.svg') }}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                    </div>
                </li>
                                ...
                                <div class="widget-content">
                                    <div class="account-box">
                                        ...
                                        <div class="info-box">
                                            <div class="icon">
                                                <span>
                                                    <img src="{{ asset('img/money-bag.png') }}" alt="money-bag">
                                                </span>
                                            </div>
                                    ...
                                    <div class="meta-info">
                                        ...
                                        <div class="avatar--group">
                                            ...
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{ asset('img/profile-8.jpeg') }}"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{ asset('img/profile-12.jpeg') }}"/>
                                            </div>
                                            <div class="avatar translateY-axis">
                                                <img alt="avatar" src="{{ asset('img/profile-19.jpeg') }}"/>
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                            <div class="widget widget-card-one">
                                <div class="widget-content">
                                    ...
                                    <div class="media">
                                        <div class="w-img">
                                            <img src="{{ asset('img/profile-19.jpeg') }}" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <h6>Jimmy Turner</h6>
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            ...
                                            <img src="{{ asset('img/profile-8.jpeg') }}" alt="avatar">
                                            <img src="{{ asset('img/profile-3.jpeg') }}" alt="avatar">
                                        </div>
