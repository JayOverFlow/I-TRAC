...
@section('content')
    <form method="POST" action="" id="po-form">
        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-body">
                <h5 class="fw-bold red-text-2 mb-4">Title: PO_TITLE_SURSAME</h5>
                <div class="row g-4">
                    <div class="col-md-6">
            ...
            <div class="card-body px-0 pb-0">
                <div class="d-flex justify-content-between ms-4 mb-1">
                    <div class="d-flex align-items-baseline gap-2">
                        <h5 class="red-text fw-bold">Add Items</h5>
                ...
                <div class="po-collapse-area" id="collapseCardAddItems">
                    <hr class="m-0 p-0">
                                ...
                                <tr class="po-item-row" data-id="1">
                                    ...
                                    <td class="px-1">
                                        <div class="input-group input-group-sm">
                                            <input type="text" class="form-control description-input" name="items[0][description]"
                                                value="">
                                    ...
                                    <td class="text-start px-0">
                                        <button type="button"
                                            class="btn border-0 bg-transparent text-black fw-bold remove-row-btn p-0 ms-2" style="visibility: hidden;">
    ...
    <div id="jsValidationToast" class="toast align-items-center text-white bg-danger border-0 shadow-lg position-fixed bottom-0 end-0 m-3" role="alert" aria-live="assertive" aria-atomic="true" style="z-index: 10000;">
        <div class="d-flex">
