    ...
    <ul class="navbar-item flex-row ms-md-auto ms-0 action-area">
            ...
            <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar-container">
                    <div class="avatar avatar-sm avatar-indicators avatar-online">
                        <img alt="avatar" src="{{ asset('img/profile-30.png') }}" class="rounded-circle procurement-avatar">
                    </div>
                </div>
            </a>
        ...
        <li class="ms-3">
            <div>
                ...
                <p id="role" class="text-decoration-underline mb-0">Procurement Office</p>
            </div>
        </li>
