            ...
            <div class="row g-4 ms-3 mt-1 mb-1">
                <div class="col-md-6">
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" name="fund_cluster" value="{{ $ics->ics_fund_cluster }}" class="form-control form-control-sm ms-2 mb-2 w-75">
                    </div>
                ...
                <div class="col-md-6 border-start-md">
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" name="ics_no" value="" class="form-control form-control-sm ms-2 mb-2 w-75">
                    </div>
                    <div class="row align-items-center mb-3">
                        <h6 class="mb-2 black-text fw-bold">Code No:</h6>
                        <input type="text" name="code_no" value="{{ $ics->ics_code_no }}" class="form-control form-control-sm ms-2 mb-2 w-75">
                    </div>
                </div>
            </div>
            <hr class="m-0 p-0">
            <div class="row g-4 ms-3 mt-1 mb-1">
                <div class="col-md-6">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm ms-2 w-75 flatpickr" name="date" value="{{ $ics->ics_received_from_date }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="row align-items-center mb-0">
                        ...
                        <input type="text" name="received_by" value="{{ $ics->receiver ? $ics->receiver->user_fullname : '' }}" class="form-control form-control-sm ms-2 mb-2 w-75">
                    </div>
                    <div class="row align-items-center mb-3">
                        <h6 class="mb-2 black-text fw-bold">Date:</h6>
                        <input type="text" class="form-control form-control-sm ms-2 w-75 flatpickr" name="date" value="{{ $ics->ics_received_by_date }}"
                            placeholder="Select Date..">
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm text-center qty-input"
                                    name="items[{{ $index }}][qty]" value="{{ $item->ics_quantity }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </td>
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm text-center"
                                    name="items[{{ $index }}][unit]" value="{{ $item->ics_unit }}">
                            </td>
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm text-center unit-cost-input"
                                    name="items[{{ $index }}][unit_cost]" value="{{ $item->ics_unit_cost }}" data-field="unit_cost"
                            ...
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm"
                                    name="items[{{ $index }}][description]" value="{{ implode(', ', array_filter(array_merge([$item->ics_items_descrip], $item->icsSpecs->pluck('ics_spec_description')->toArray()))) }}">
                            </td>
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm text-center"
                                    name="items[{{ $index }}][inventory_item_no]" value="{{ $item->ics_inventory_item_no }}">
                            </td>
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm text-center"
                                    name="items[{{ $index }}][estimated_useful_time]" value="">
                            </td>
                            <td class="p-0">
                                <button type="button"
