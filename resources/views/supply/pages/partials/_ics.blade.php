<div class="col-md-9 ics-container">
    <div class="card shadow-sm border-0 mb-3">
        <div class="card-body px-0 pb-0">
            ...
            <div class="row g-4 ms-3 mt-1 mb-1">
                ...
                <div class="col-md-6 border-start-md">
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" name="ics_no" class="form-control form-control-sm ms-2 mb-2 w-75">
                    </div>
                    <div class="row align-items-center mb-3">
                        <h6 class="mb-2 black-text fw-bold">Code No:</h6>
                        <input type="text" name="code_no" class="form-control form-control-sm ms-2 mb-2 w-75">
                    </div>
                </div>
            </div>
            <hr class="m-0 p-0">
            ...
            <div class="text-center my-2">
                <button type="button" class="btn border-0 bg-transparent text-black fw-bold" id="icsAddItemBtn">+ Add
                    Item</button>
            </div>
        </div>
    </div>
