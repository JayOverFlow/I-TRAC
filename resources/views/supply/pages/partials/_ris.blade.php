            ...
            <div class="row g-4 ms-3 mt-0 mb-1">
                <div class="col-md-6">
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" name="fund_cluster" value="{{ $ris->ris_fund_cluster }}" class="form-control form-control-sm ms-2 w-75">
                    </div>
                    <div class="row align-items-center mb-3">
                        <h6 class="mb-2 black-text fw-bold">RIS Number:</h6>
                        <input type="text" name="ris_no" value="" class="form-control form-control-sm ms-2 w-75">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" name="responsibility_center_code" value="{{ $ris->ris_center_code }}"
            ...
            <div class="row g-4 ms-3 mt-0 mb-1">
                ...
                <div class="col-md-6">
                    <div class="row align-items-center mb-3">
                        ...
                        <input type="text" name="ris_date" value="{{ $ris->ris_date }}" class="form-control form-control-sm ms-2 mb-2 w-75 flatpickr" placeholder="Select Date..">
                    </div>
                </div>
            </div>
            <hr class="m-0 p-0">
                ...
                <table class="table table-sm table-borderless align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-1">
                                <input type="text" class="form-control form-control-sm text-center"
                                    name="items[{{ $index }}][qty_requisition]"
