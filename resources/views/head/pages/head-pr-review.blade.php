...
@section('title', 'Purchase Request Review | I-TRAC')
    ...
    <div class="card allocated-budget-card mb-3">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <div class="text-end">
                    @if ($task->task_status === 'Pending')
                        <form action="{{ route('approve.pr', $task->task_id) }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" id="approve-pr-btn"
                                class="btn border border-light-subtle btn-dark-red d-inline-flex align-items-center gap-1 px-3">
                                <img src="{{ asset('img/Approve.svg') }}" width="18" height="18">
                                <span>Approve</span>
                            </button>
                        </form>

                        <form action="{{ route('reject.pr', $task->task_id) }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" id="reject-pr-btn"
                                class="btn border border-light-subtle btn-gray d-inline-flex align-items-center gap-1 px-3">
                                <img src="{{ asset('img/Reject.svg') }}" width="18" height="18">
                                <span>Reject</span>
                            </button>
                        </form>
