...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-body">
            <h5 class="card-title fw-bold"><span class="red-text-2">Item 1</span> | Procurement Project Details</h5>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Including Sustainability and Domestic
                        Preference">
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="text" class="form-control" id="" placeholder="In Peso">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Other relevant descriptions of the procurement project, if applicable">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-end mb-3">
        <button class="btn btn-red">Add Project</button>
    </div>

    <div class="d-flex justify-content-end">
        <h4><span class="fw-bold">Total Amount:</span>12,345.00</h4>
    </div>
@endsection
